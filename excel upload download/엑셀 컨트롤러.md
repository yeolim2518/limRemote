...
public class ExcelController {
	 ...
	 * [param]
	 * 		1. MultipartHttpServletRequest mRequest
	 * 			- 뷰페이지에서 업로드한 엑셀 파일
	 * 		2. HttpServletResponse response
	 * 			- 엑셀 데이터(JSON)으로 전송 하기 위한 객체
	...
	public void excelUploadAjax(MultipartHttpServletRequest mRequest,
		...
		try {
			...
			// mvc보내고, impl에서 오류남. => java>egov>example> cmmn안에 excel폴더째로 넣기~!!!!!
	 ...
	 * [param]
	 * 		1. String param
	 * 			- HTML 데이터를 담기위한 string
	 * 		2. HttpServletResponse response
	 * 			- 전송결과를 전송 하기 위한 객체
	 * */	
	@RequestMapping(value = "excelDownloadAjax.do", method = RequestMethod.POST)
	public void excelDownloadAjax(@RequestBody String param,
